...
<html>
    <head>
        ...
        <title>Sistema Hotel Holiday UTEQ| Inicio</title>
        ...
        <!-- Theme style -->
        <link href="<%= AppHelper.baseUrl() %>assets/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css"/>
        ...
        <link rel="stylesheet" href="<%= AppHelper.baseUrl() %>assets/dist/css/skins/skin-blue.min.css">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Sistema </b>Hotel Holiday UTEQ</span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <img src="<%= AppHelper.baseUrl() %>assets/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                                    <!-- hidden-xs hides the username on small devices so only the image appears. -->
                                    <span class="hidden-xs"> ${user.nombreUsuario}</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- The user image in the menu -->
                                    <li class="user-header">
                                        <img src="<%= AppHelper.baseUrl() %>assets/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-right">
                                            <a href="<%= AppHelper.baseUrl() %>logout" class="btn btn-default btn-flat">Cerrar Session</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2020 <a href="#">HolidayUteq</a>.</strong> Todos los derechos reservados.
            </footer>
        ...
        <!-- AdminLTE App -->
        <script src="<%= AppHelper.baseUrl() %>assets/dist/js/adminlte.min.js"></script>
...
<%   
    ...
    } else { response.sendRedirect(AppHelper.baseUrl() + "login"); }
