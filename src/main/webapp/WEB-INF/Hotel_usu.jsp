  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<%= AppHelper.baseUrl() %>Menu">Restaurante</a>
        </li>
        <li class="nav-item">
     ...
     <div>
        <div>
            <ul class="navbar-nav mr-auto"> 
                 <li class="nav-item"><a href="<%= AppHelper.baseUrl() %>logout"> <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Cerrar sesión</button></a></li>
            </ul>
         </div>
     </div>
  </nav>           
